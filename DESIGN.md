...
| **7a — Technologies, première tranche** — ✅ **complétée le 01/09** (REPORT-PHASE7A.md) : base relationnelle `techs.json` (9 techs) + intégrité par CI ; recherche R-85/R-86/R-87 (SetResearch immédiat, progression conservée, filtrage production) ; Archer/Cavalier/Légion ; menu de recherche UI ; migration v5. Décisions 7b suivies (Bibliothèque/Caserne effectives) | Recherche visible et rentable ✅ | — |
| **7b — Refonte du menu de ville** — ✅ **complétée le 01/09** (REPORT-PHASE7B.md) : étude + maquette approuvées par Erik, puis implémentation — **R-88 Bibliothèque** (or : max(1 ; 20 %) science / science : ×1,5), **R-89 Caserne** (unités produites vétérans), **R-90 conversion or/science binaire par ville** (amende R-61, migration v6), crash du menu corrigé (anomalie 7a), refonte CityPanel (durations, production catégorisée, ETA), cases travaillées par conversion sur la carte, Rendements en 3 états | Menu de ville complet et accessible ✅ | — |
| **7c — Terrains & ressources exhaustives** *(handoff prêt : HANDOFF-PHASE7C.md — recherche déléguée à l'agent, 01/09)* | Ressources de terrain data-driven, calibrables, visibles/cachées selon les techs | **L0 immédiat** : carte de test variée + démarrage sans colon (1 guerrier adjacent à la ville) ; **recherche exhaustive** terrains/ressources Civ Revolution (déléguée à l'agent) ; modèle de données **éditable** (placement par terrains, visibilité tech, bonus — tout modifiable sans code) ; concept « culture » à instruire et proposer (arrêt pour approbation) |
| **7d — Barbares & huttes bonus** *(prérequis de la procédurale — 01/09)* | Des barbares rôdent et des huttes donnent des bonus, comme Civ Revolution | Unités barbares (IA simple, spawns), huttes à ouvrir (récompenses aléatoires seedées), équilibrage avec l'économie 7c |
| **6b — Génération procédurale** *(reportée après 7d — s'appuiera sur les rendements (6), les ressources (7c) et les barbares/huttes (7d))* | Cartes aléatoires équitables | Bruit + placement symétrique des spawns, checksum d'équité, seeds rejouables |
...
| **7e — Arbre technologique complet & contenu terrestre** — ✅ **complétée le 02/09** (REPORT-PHASE7E.md) : 46 techs (ères, **Premier découvreur R-109**, **obsolescence R-110**, **remplacements de bâtiments R-111**), 23 unités dont 12 terrestres jouables avec **R-59 réelle** (attaque à distance sans avancée ni riposte), 22 bâtiments à effets (**Grenier +2 N** — point 6c résolu, Remparts, Aqueduc, Marché/Banque/Université, Usine, Palais), **R-112 Colon à 2 population** (décision d'Erik, comportement officiel), merveilles en données, migration v9 | L'arbre complet du PDF en données ✅ | — |
| **7f — Culture** *(handoff prêt : HANDOFF-PHASE7F.md — spec rédigée par Erik : « Culture dans Civilization Revolution.md »)* | Rendements culturels (Palais/Temple/Cathédrale par pop), Personnages Illustres de culture (spawn à seuil croissant, installation = jalon), compteur de 20 jalons, **Nations Unies → victoire culturelle** ; 3 merveilles à effets simples activées (Stonehenge, Colosse, Jardins suspendus) | Tranche 1 : yields + GPs + jalons + UN. **Reportés avec accord d'Erik à trancher** : conversion culturelle passive (concept de territoire à définir), autres types de GP, interplay espionnage (7g), mods gouvernementaux (7h) |
| **7f — Culture** *(spec rédigée par Erik : « Culture dans Civilization Revolution.md » — handoff après 7e)* | Rendements culturels (Palais/Temple/Cathédrale par pop), Personnages Illustres, 20 jalons, conversion culturelle, victoire par Nations Unies | Le spec d'Erik fait foi — tranches à cadrer à l'acceptation de 7e (conversion passive, espionnage, gouvernement mods) |
| **7g — Naval & Espionnage** *(après 7f — hook `navalAccess` prêt depuis 6c)* | Battements navals côte/océan, espions dérobaient Personnages Illustres | Mécanique naval (Galère coast / Galion ocean), Espion (vol de GP, révolte ?), Caravane |
| **7h — Gouvernements, Civilisations & merveilles** *(après 7g)* | Régimes politiques (Monarchie ×2 culture Palais, Communisme −Temples…), choix de civilisation avec traits (Rome merveilles −50 %…), effets des merveilles + Nations Unies | Interdépendant avec 7f (gouvernements modulent la culture) — cadrer à l'acceptation de 7f |
| **7 — Contenu Civ Revolution** | Le vrai jeu | Décomposé en tranches 7a→7h ci-dessus + **engagements multi-participants** (BACKLOG.md idée 2, §7.9 à formaliser) |
