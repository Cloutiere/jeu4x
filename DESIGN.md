...
| **7e — Arbre technologique complet & contenu terrestre** *(handoff prêt : HANDOFF-PHASE7E.md — 02/09)* | L'arbre complet du PDF en données ; toutes les unités terrestres (dont **à distance**, R-59 implémentée) et bâtiments terrestres avec effets | Arbre complet `techs.json` (coûts 🔶 calibrables) ; Piquier/Catapulte/Chevalier/Fusilier/Canon/Infanterie/Char/Artillerie jouables ; bâtiments terrestres + effets (Remparts, Aqueduc, +% économiques ; effets culturels en données pour 7f) ; merveilles/naval/espion en données seules ; assets via le générateur |
