...
| 40 entités `unite_*`/`ville_*` (+ `_accent`) | Généré par tools/generate.py | Licence projet |
| 10 icônes `icone_*.png` | Généré par tools/generate.py | Licence projet |
...
Dernière génération : 2026-09-03
