...
| 34 entités `unite_*`/`ville_*` (base + accent — dont les 5 nouvelles classes GP dédiées 7k) | Généré par tools/generate.py | Licence projet |
...
Dernière génération : 2026-09-04
