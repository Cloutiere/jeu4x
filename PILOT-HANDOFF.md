...
5. **Chantier « Espionnage avancé » (BACKLOG.md idée 5 — Erik, 05/09)** : après la 7m — espions infiltrés (s'installent et disparaissent, XP et déblocage de capacités), points d'espionnage/contre-espionnage, bâtiments de contre-espionnage, menu de renseignement dès le premier contact, fenêtre d'annulation au tour de la victime, redirection de troupes au tour débuté, réduction de brouillard, vol de tech/d'or/d'unités, assassinat. À découper en plusieurs phases — Erik veut l'espionnage au centre du gameplay dès l'Écriture ;
6. **7n — Civilisations & traits** (reporté, clés préparées 7i) : **doc « Guide Civilisations » d'Erik committé** (16 civs — bonus de départ + bonus par passage d'ère), hooks économiques prêts (intérêts 2 %, rush ×0,5) ;
7. **Phase Artefacts** (Angkor Wat, Arche d'Alliance, École de Confucius, Atlantide — doc « Merveilles et Personnages » §Distribution cartographique, couplée à la génération procédurale) ;
8. **Phase 8** — polish, équilibrage, esthétique ;
9. **Chantier visuel 3D** — deux voies documentées (2.5D isométrique via generate.py = quick win ; vraie 3D Three.js = phase dédiée, avec spike préalable) ;
10. **En suspens d'Erik à cadrer** : territoire/frontières (prérequis du flip culturel Artiste consume et d'Hollywood), sauts technologiques. **Rapports de recherche encore attendus** : XP & promotions d'unité (le « +3 XP » du Leader = « vétérans » en attendant) ; territoire & conversion culturelle.
11. **Calibrage en attente d'Erik** : 🔶 7l — facteur Industrielle ×5, sac de ville 0,5, classe des GP du canal or (R-127) ; 🔶 7i — commerce du centre-ville par tranche (0 sous pop 7) ; 🔶 7m — moitié de bâtiments (arrondi), pénalité culturelle (défaut −1 jalon), Grande Muraille vs ICBM (défaut : ne bloque pas), % de vol d'or (50), matrice de duels d'espions, mode de sélection du bâtiment à détruire, GP en attente détruits par l'explosion.
