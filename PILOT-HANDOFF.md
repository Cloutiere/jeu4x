...
1. **Préalables** : lecture des docs normatifs, baseline (tests + typecheck verts, ~613 actuellement), `schemaVersion` courant (**14**), leçons récentes ;
...
3. **7l — Or & trésorerie** — ✅ **handoff prêt : HANDOFF-PHASE7L.md** (05/09, avec Bloc 0 = décisions d'Erik du 05/09) : trésorerie d'empire (R-90 binaire **confirmée fidèle** par le doc), zéro entretien, rush-buy (facteurs d'ère data-driven 🔶 2/3/5/8, interdits ONU/WM, 1/ville/tour, Complexe −20 % achat), paliers économiques (100 Colon → 20 000 Banque mondiale), Banque mondiale = **victoire économique** (or non débité, condition dynamique 20 000), Explorateur consume or activé (50/100/200/400), surplus de recherche → or, camp barbare +50 or, hooks 7n (intérêts 2 %, réduction rush) ;
...
1. **7k est livrée et vérifiée le 04/09** (613 tests, prod saine, commit `f83ba9f`) — reste la vérification en ligne par Erik (liste §4) et **son arbitrage : coût ONU 500 (doc) vs 300 (T-28 🔶 7f)**.
2. Recueillir ses votes de calibrage (§4 : liste 7i, 🔶 7j restants — multiplicateurs Settle additifs —, 🔶 7k ci-dessus) et les consigner dans RULES.md/JSON.
3. **Préparer le handoff 7l — Or & trésorerie** (trésorerie joueur inexistante : le commerce est converti à 100 % en or OU science, R-90 ; rush-buy, Banque mondiale = victoire économique 20 000 or, canaux GP par or 500/10 000, injection d'or Explorateur consume, « coût d'achat » du Complexe militaro-industriel). Décision de design majeure : que devient la conversion binaire or/science quand l'or s'accumule — arrêt-pour-approbation prévu.
4. Puis 7m (ICBM/SDI + contre-espionnage), 7n (civilisations — doc d'Erik committé), phase Artefacts, Phase 8.
