...
4. **7m — ICBM/SDI + espionnage jeu de base** — ✅ **handoff prêt : HANDOFF-PHASE7M.md** (05/09, avec Bloc 0 = décisions ICBM d'Erik du 05/09 : résolution unifiée — ville survit pop 2, moitié des bâtiments détruite au hasard, merveilles et GP installés préservés, toutes les unités du rayon 1 détruites) : Manhattan 750 → ICBM unique instanciée (40 PM, Launch, interdit sous Démocratie, pénalité culturelle 🔶, frappe ≠ domination), SDI 200/Superconducteurs interception 100 % locale (exploit adjacent conservé), espion jeu de base (25/Écriture, réseau ×3, 6 actions : vol d'or 50 % 🔶, kidnap GP en attente + vol d'installé R-119, sabotage, destruction de bâtiment, destruction des fortifications, partir discrètement, consommation, duels d'espions 🔶, garnison = seul contre-espionnage canon) ;
