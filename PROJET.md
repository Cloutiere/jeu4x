...
**Production** : [game-4x-server-prod.erik-ai-studio.workers.dev](https://game-4x-server-prod.erik-ai-studio.workers.dev) · **1091 tests verts** · `schemaVersion` **22** · budget Cloudflare tenu (~5 $/mois).
