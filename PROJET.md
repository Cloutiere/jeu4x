...
**Production** : [game-4x-server-prod.erik-ai-studio.workers.dev](https://game-4x-server-prod.erik-ai-studio.workers.dev) · **1052 tests verts** · `schemaVersion` **19** · budget Cloudflare tenu (~5 $/mois).
