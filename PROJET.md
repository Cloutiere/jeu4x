...
**Production** : [game-4x-server-prod.erik-ai-studio.workers.dev](https://game-4x-server-prod.erik-ai-studio.workers.dev) · **1069 tests verts** · `schemaVersion` **20** · budget Cloudflare tenu (~5 $/mois).
