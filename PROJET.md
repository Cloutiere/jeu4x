...
**Production** : [game-4x-server-prod.erik-ai-studio.workers.dev](https://game-4x-server-prod.erik-ai-studio.workers.dev) · **1126 tests verts** · `schemaVersion` **23** · budget Cloudflare tenu (~5 $/mois).
