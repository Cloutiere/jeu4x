...
| Grand Bâtisseur (`batisseur`) | accumulateur production T-30 | **achève la production en cours** (unité, bâtiment ou merveille) | **−50 % marteaux** des futurs BÂTIMENTS de la cité |
| Grand Savant (`savant`) | accumulateur science T-30 | **achève la recherche active** (complétion normale — Premier découvrir applicable) | **+50 % Science** de la cité hôte |
| Grand Explorateur / Industriel (`explorateur`) | accumulateur or T-30 | injection d'or (50/100/200/400 selon l'ère) — **INACTIF v1** (trésorerie, 7l) | **+50 % Or** de la cité hôte |
| Grand Humanitaire (`humanitaire`) | **canal CULTURE (révision 7k · C1 — veto d'Erik du 04/09 : il est produit comme les autres GP, ciblage technologique R-127 et rotation des 6 classes compris)** — l'accumulateur `city.gpAccumFood` (7j) est SUPPRIMÉ du moteur : champ conservé DORMANT en état (compat saves, jamais crédité ni lu) | **+1 pop à TOUTES les cités** de l'empire | **+50 % croissance** (surplus alimentaire ×1,5) de la cité hôte |
