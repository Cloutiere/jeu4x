...
Base : la spécification d'Erik [`Civilization Revolution _ Merveilles et Personnages.md`](Civilization%20Revolution%20_%20Merveilles%20et%20Personnages.md), section « Les Grands Personnages » (tableau Consume/Settle — elle fait foi). Sources croisées : CivFanatics Great People, StrategyWiki Famous People. **Décisions de tranche (pilotage 7j)** : le **ciblage technologique est une pondération DÉTERMINISTE** 🔶 (pas de nouveau RNG) ; les GP restent des **compteurs + entités de ville** (PAS d'unité mobile sur la carte — écart documenté avec le doc, modèle conservé, D4.4) ; les canaux **or (500 / 10 000 pièces) sont REPORTÉS 7l** (pas de trésorerie) ; le **flip culturel (Consume Artiste/Penseur) est REPORTÉ** (territoire en suspens).
