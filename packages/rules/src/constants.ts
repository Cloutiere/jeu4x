...
/** R-63 · OBSOLÈTE : le seuil 10 × pop vit dans la table growth.json
 *  (growthThresholds, indexée par population ACTUELLE — ALIGNEMENT-CROISSANCE
 *  13/09, la constante n'est plus lue par le moteur : packages/rules/src/growth.ts). */
