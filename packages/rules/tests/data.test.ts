...
describe('Données Phase 6 (RULES.md §2 révisé + R-66)', () => {
  it('rendements §2 révisés : plaine 1/0/0, forêt 0/2/0, colline 0/1/0, prairie 2/0/0, ville 0/0/0 (ALIGNEMENT-CROISSANCE 13/09 — la case de ville ne rapporte RIEN, socle R-66 abrogé)', () => {
    ...
    expect(terrainTable['ville']!.yields).toEqual({ food: 0, production: 0, commerce: 0 });
  });
