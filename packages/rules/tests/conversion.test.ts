...
describe('R-90/R-88 · Phase C — la conversion alimente or et science (resolveTurn)', () => {
  /** Ville p1 avec une case désert travaillée (0/0/1 C) ; ALIGNEMENT-CROISSANCE :
   *  la case de ville rapporte 0 (socle R-66 abrogé) et la tranche R-60bis
   *  ajoute 0 sous pop 7 → C=1. */
  ...
  it('R-88 : ville à bibliothèque en conversion or → 1 or + 1 science (max(1 ; round(0,4)))', () => {
...
describe('migration v5 → v6 (R-90)', () => {
  it('v6 : chaque ville gagne conversion, défaut or ; champ existant conservé', () => {
    ...
    expect(out.schemaVersion).toBe(20); // la chaîne continue (EXPANSION-CULTURELLE : cultureCumulee)
